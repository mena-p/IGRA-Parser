...
while ischar(headerLine)  
    if headerLine(1) == '#' % header found
        ...
        sounding = struct('stationID','<undefined>',...
            ...
            'inversionPressure','<undefined>',...
            'inversionHeight','<undefined>',...
            'inversionTempDiff','<undefined>',...
            'mixedLayerPressure','<undefined>',...
            'mixedLayerHeight','<undefined>',...
            'freezingPressure','<undefined>',...
            'freezingHeight','<undefined>',...
            'LCLpressure','<undefined>',...
            'LCLheight','<undefined>',...
            'LFCpressure','<undefined>',...
            'LFCheight','<undefined>',...
            'LNBpressure','<undefined>',...
            'LNBheight','<undefined>',...
            'liftedIndex','<undefined>',...
            'showalterIndex','<undefined>',...
            'kIndex','<undefined>',...
            'totalTotalsIndex','<undefined>',...
            'CAPE','<undefined>',...
            'CIN','<undefined>',...
            'derived','<undefined>');
